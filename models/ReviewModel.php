...
class ReviewModel extends CModel{
	...
	*/
    ...
    public function getreviewlistbycrid($param) {
        ...
        $sql = 'select r.logid,r.upid,r.dateline,r.subject,u.username,u.realname,c.uid as authorid,c.cwid,c.title,c.cwurl,r.shield,u.uid,u.sex,u.groupid,u.face,r.replyuid,r.replysubject,r.replydateline,c.ism3u8 from  ebh_reviews r ' .
                'join ebh_users u on (u.uid = r.uid) ' .
