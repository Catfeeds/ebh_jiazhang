...
function changeday(daystate){
	...
	var url = 'active.html?daystate='+daystate+dayparam;
	location.href = url;
}
...
<body>
<?php $this->display('common/headertop'); ?>
<?php $this->display('common/jiazhang_header'); ?>
<div class="mainst">
<div class="ter_tit"> 当前位置 > 活跃度表 </div>
...
<?php }?>
<div class="rigping" style="padding-left:20px;width:600px">
