...
$(function() {
   ...
   $("#ser").click(function(){
       ...
       if(title == searchtext) 
           title = "";
       var url = '<?= geturl('askquestion/myanswer') ?>' + '?q='+title;
...
<div class="workol">
	<div class="work_mes">
		<ul>
			...
			<li class="workcurrent"><a href="<?= geturl('askquestion/myanswer') ?>"><span>我的回答</span></a></li>
...
<div class="diles">
			...
			<div class="workdata" style="margin-top:0px;float:left;">
				...
				<table  width="100%" class="datatab" style="border:none;">
			  	...
			  	<tbody>
                                <?php if(empty($asks)) { ?>
			  		<tr><td colspan="6" align="center" style="border-top:none;">目前没有我的回答</td></tr>
                                <?php } else { ?>
