...
<div class="workol">
	<div class="work_mes" style="width:998px; position:relative;">
		<ul style="float:left; display:inline;">
			...
			<li class="workcurrent"><a href="<?= geturl('myask/myquestion') ?>"><span>我的问题</span></a></li>
		...
		<?php }?>
			...
			<div class="workdata" style="margin-top:0px;float:left; width:998px;">
				<table  width="100%" class="datatab" style="border:none;">			  
			  	<tbody>			  
                                <?php if(empty($asks)) { ?>
			  		<tr><td colspan="5" align="center" style="border:none;"><img src="http://static.ebanhui.com/ebh/tpl/2014/images/zanwujilu.png"></td></tr>
							<?php } else { ?>
...
initsearch("title",searchtext);
	$("#ser").click(function(){
		...
		if(title == searchtext) 
			title = "";
		var url = '<?= geturl('myask/myquestion') ?>' + '?q='+title;
		<?php if(!empty($folder)){
...
function delask(qid,title) {
    var url = '<?= geturl('myask/delask') ?>';
    var successurl = '<?= geturl('myask/myquestion') ?>';
