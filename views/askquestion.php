...
<div class="workol">
	<div class="work_mes">
		<ul>
			<li class="workcurrent"><a href="<?= geturl('askquestion') ?>"><span>全部问题</span></a></li>
			<li><a href="<?= geturl('askquestion/myquestion') ?>"><span>我的问题</span></a></li>
										...
										<td style="border-top:none;">
											<?php $name=empty($avalue['realname'])?$avalue['username']:$avalue['realname'] ?>
												<div style="float:left;margin-right:15px;"><img title="<?= empty($avalue['realname'])?$avalue['username']:$avalue['realname'] ?>" src="<?=$face?>" /></div>
													...
													<span style="width:160px;float:left;"><?= Date('Y-m-d H:i:s',$avalue['dateline']) ?></span>
													<span class="huirenw" style="width:120px;float:left;"><?= empty($avalue['realname'])?$avalue['username']:$avalue['realname'] ?></span>
													<span class="ketek"><?= $avalue['foldername'] ?></span>
													
													</div>
													<?php if(!empty($avalue['cwid'])){?>
													<div style="float:left;width:600px;margin-top:5px">
													<span class="" style="margin-left:324px"><?=shortstr($avalue['cwname'],40)?></span>
													</div>
													<?php }?>
												</div>
