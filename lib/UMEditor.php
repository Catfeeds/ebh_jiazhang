...
class UMEditor {
    ...
    public function simpleEditor($name, $width, $height, $value = NULL) {
        ...
        $str .= '<script src="http://static.ebanhui.com/ebh/js/imgeditor.js" type="text/javascript"></script>';
		$str .= '<link href="http://static.ebanhui.com/ebh/tpl/default/css/public.bak.css" type="text/css" rel="stylesheet"></link>';
        $str .= '<script type="text/javascript" src="/lib/um/lang/zh-cn/zh-cn.js"></script>';
        $str .= '<script type="text/plain" id="' . $name . '" style="width:' . $width . ';height:' . $height . '"></script>';
        $str .= '<script type="text/javascript">';
        $imagephp = geturl('uploadimage');
        $str .= 'var ue = UM.getEditor("' . $name . '",{textarea:"' . $name . '",imageUrl:"' . $imagephp . '",autoHeightEnabled:false,imagePath:"",toolbar:[\'formula imgeditor undo redo | bold italic underline strikethrough | forecolor backcolor | removeformat |\',
    ...
    public function pEditor($name, $width, $height, $value = NULL) {
        ...
        $str .= '<script src="http://static.ebanhui.com/ebh/js/imgeditorv2.js" type="text/javascript"></script>';
        $str .= '<link href="http://static.ebanhui.com/ebh/tpl/default/css/public.bak.css" type="text/css" rel="stylesheet"></link>';
        $str .= '<script type="text/javascript" src="/lib/um/lang/zh-cn/zh-cn.js"></script>';
        $str .= '<script type="text/plain" id="' . $name . '" style="width:' . $width . ';height:' . $height . '"></script>';
        $str .= '<script type="text/javascript">';
        $imagephp = geturl('uploadimage');
        $str .= 'var ue = UM.getEditor("' . $name . '",{textarea:"' . $name . '",imageUrl:"' . $imagephp . '",autoHeightEnabled:false,imagePath:"",toolbar:[\'formula imgeditor undo redo | bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat |\',
            \'insertorderedlist insertunorderedlist | fontsize\' ,
            \'| justifyleft justifycenter justifyright justifyjustify |\',
            \'image\'
        ]});';
